...
require('packer').startup(function()
  ...
  use 'arcticicestudio/nord-vim' -- Theme inspired by Atom
...
vim.api.nvim_set_keymap('n', '<leader>t', ':15split term://bash<CR>', { noremap = true, silent = true })
...
local on_attach = function(_, bufnr)
  ...
  vim.api.nvim_buf_set_keymap(bufnr, 'n', '<leader>ga', '<cmd>lua vim.lsp.buf.add_workspace_folder()<CR>', opts)
  vim.api.nvim_buf_set_keymap(bufnr, 'n', '<leader>gr', '<cmd>lua vim.lsp.buf.remove_workspace_folder()<CR>', opts)
  vim.api.nvim_buf_set_keymap(bufnr, 'n', '<leader>gl', '<cmd>lua print(vim.inspect(vim.lsp.buf.list_workspace_folders()))<CR>', opts)
...
local servers = { 'clangd', 'rust_analyzer', 'pyright', 'texlab', 'solargraph', 'tsserver' }
